...
class ListExtensionsTest {
    ...
    @Test
    fun testConcat2OnEmptyListOfLists() {
        assertEquals(
            emptyList(),
            emptyList<List<Int>>().customConcat2()
        )
    }

    @Test
    fun testConcat2OnNonEmptyListOfLists() {
        assertEquals(
            listOf('1', '2', '3', '4', '5', '6'),
            listOf(listOf('1', '2'), listOf('3'), emptyList(), listOf('4', '5', '6')).customConcat2()
        )
    }
