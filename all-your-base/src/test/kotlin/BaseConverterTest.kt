...
class BaseConverterTest {
    ...
    fun testSingleBitOneToDecimal() {
        ...
        val actualDigits: IntArray = baseConverter.convertToBase(10)
    ...
    fun testSingleDecimalToBinary() {
        ...
        val actualDigits: IntArray = baseConverter.convertToBase(2)
    ...
    fun testTrinaryToHexadecimal() {
        ...
        val actualDigits: IntArray = baseConverter.convertToBase(16)
    ...
    fun testHexadecimalToTrinary() {
        ...
        val actualDigits: IntArray = baseConverter.convertToBase(3)
    ...
    fun test15BitInteger() {
        val baseConverter = BaseConverter(97, intArrayOf(3, 46, 60))    // 32749

        val expectedDigits = intArrayOf(6, 10, 45)
        val actualDigits: IntArray = baseConverter.convertToBase(73)
